...
public class FriendshipServiceDeclineTest {
    ...
    @Test
    public void shouldDeclineFriendshipSuccessfully() throws NotValidRegisterException, UserNotFoundException, IncorrectPasswordException, NotValidFriendshipRequestException, CannotDeclineFriendshipException {
    ...
    public void shouldNotAcceptFriendshipIncorrectPasword() throws NotValidRegisterException, UserNotFoundException, IncorrectPasswordException, NotValidFriendshipRequestException, CannotDeclineFriendshipException {
        User userFrom = UserBuilder.builder().withUsername(Username.create("username1")).withPassword(Password.create("password123")).build();
        User userTo = UserBuilder.builder().withUsername(Username.create("username2")).withPassword(Password.create("password456")).build();
    ...
    public void shouldNotAcceptFriendshipBecauseTheyAreFriends() throws NotValidRegisterException, UserNotFoundException, IncorrectPasswordException, NotValidFriendshipRequestException, CannotDeclineFriendshipException {
        User userFrom = UserBuilder.builder().withUsername(Username.create("username1")).withPassword(Password.create("password123")).build();
        User userTo = UserBuilder.builder().withUsername(Username.create("username2")).withPassword(Password.create("password456")).build();
    ...
    @Test(expected = CannotDeclineFriendshipException.class)
    public void shouldNotAcceptFriendshipBecauseThereIsNoRequest() throws NotValidRegisterException, UserNotFoundException, IncorrectPasswordException, NotValidFriendshipRequestException, CannotDeclineFriendshipException {
        User userFrom = UserBuilder.builder().withUsername(Username.create("username1")).withPassword(Password.create("password123")).build();
        User userTo = UserBuilder.builder().withUsername(Username.create("username2")).withPassword(Password.create("password456")).build();
