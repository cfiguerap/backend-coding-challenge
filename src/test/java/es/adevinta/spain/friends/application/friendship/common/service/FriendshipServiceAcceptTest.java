...
public class FriendshipServiceAcceptTest {
    ...
    public void shouldNotAcceptFriendshipBecauseTheyAreFriends() throws NotValidRegisterException, UserNotFoundException, IncorrectPasswordException, NotValidFriendshipRequestException, CannotAcceptFriendshipException {
        User userFrom = UserBuilder.builder().withUsername(Username.create("username1")).withPassword(Password.create("password123")).build();
        User userTo = UserBuilder.builder().withUsername(Username.create("username2")).withPassword(Password.create("password456")).build();
